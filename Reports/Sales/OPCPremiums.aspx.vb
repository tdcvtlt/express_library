...
Partial Class Reports_Sales_OPCPremiums
    Inherits System.Web.UI.Page


    Dim Report As ReportDocument = Nothing
    Dim ReportPath As String = "reportfiles/OPCPREMIUMS.rpt"
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            '
            'Needed in case of CR < || > button was clicked for paging
    ...
    Private Sub LoadReport()
        ...
        Try
            ...
            Report.SetParameterValue("EndDate", dpTo.Selected_Date)
