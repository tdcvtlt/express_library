...
Imports System.Data
Imports System
Partial Class Reports_Tours_ToursByStatus
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/ToursByStatus.rpt"
    ...
    Protected Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
        If dteSDate.Selected_Date <> "" And dteEDate.Selected_Date <> "" And siStatus.Selected_ID > 0 Then
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("statusID", siStatus.Selected_ID)
