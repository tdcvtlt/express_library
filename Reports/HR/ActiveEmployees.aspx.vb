...
Partial Class Reports_HR_ActiveEmployees
    Inherits System.Web.UI.Page

    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/ActiveEmployees.rpt"
    ...
    Private Sub BindData()
        ...
        Dim cmd As New SqlCommand("select b.COMBOITEM, b.COMBOITEMID from t_combos a inner join t_comboitems b on a.comboid = b.comboid where comboname = 'PersonnelStatus'", cnn)
        cnn.Open()
    ...
    Protected Sub Set_Params()
        ...
        Next
        Report.SetParameterValue("pStatus", sItems)
