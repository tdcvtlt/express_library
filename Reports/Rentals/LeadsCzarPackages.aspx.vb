...
Imports System.Data
Imports System
Partial Class Reports_Rentals_LeadsCzarPackages
    Inherits System.Web.UI.Page

    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/LeadsCzarPackagesSold.rpt"

    Private Sub BindData()
        Dim cnn As New SqlConnection(Resources.Resource.cns)
        Dim cmd As New SqlCommand("Select packageid, package from t_Package where package like '%CZAR%' or package like 'cali%' or package like 'flo%' order by package", cnn)
        cnn.Open()
        'ListBox1.Items.Add(New ListItem("All", "1"))
        ListBox1.DataSource = cmd.ExecuteReader()
        ListBox1.DataTextField = "Package"
        ListBox1.DataValueField = "PackageID"
    ...
    Protected Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRunReport.Click
        If dfStartDate.Selected_Date <> "" And dfEndDate.Selected_Date <> "" And ListBox2.Items.Count > 0 Then
    ...
    Protected Sub Set_Params()
        ...
        Next
        Report.SetParameterValue("pkgs", sItems)
