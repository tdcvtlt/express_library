...
Partial Class Reports_Rentals_ReservationSpotCheck
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/ReservationSpotCheck.rpt"

    Private Sub BindData()
        Dim oPers As New clsPersonnel2Dept
        ListBox1.DataSource = oPers.Get_Members("Reservations")
        ListBox1.DataTextField = "UserName"
        ListBox1.DataValueField = "PersonnelID"
        ListBox1.DataBind()
    End Sub
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("DateBooked", ddField.SelectedValue.ToString)
        ...
        If ListBox1.Items.Count = 0 Then
            sItems &= ",0"
        End If
        Report.SetParameterValue("reps", sItems)
        'ClientScript.RegisterClientScriptBlock(Me.GetType, "AjaxCall", "alert('" & sItems & "');", True)
    End Sub
