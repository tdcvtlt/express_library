...
Partial Class Reports_Rentals_PackageAgent
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/upgradeextranight.rpt"
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("EDate", CDate(IIf(dfEndDate.Selected_Date <> "", dfEndDate.Selected_Date, Date.Today)).AddDays(1))
