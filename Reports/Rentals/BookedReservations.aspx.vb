...
Partial Class Reports_Rentals_BookedReservations
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/BookedReservationsbydate.rpt"

    Private Sub BindData()
        Dim cnn As New SqlConnection(Resources.Resource.cns)
        Dim cmd As New SqlCommand("select b.COMBOITEM, b.COMBOITEMID from t_combos a inner join t_comboitems b on a.comboid = b.comboid where comboname = 'ReservationLocation'", cnn)
        cnn.Open()
