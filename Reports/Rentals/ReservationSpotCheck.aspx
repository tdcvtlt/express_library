<%@ Page Title="Booked Reservations" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="ReservationSpotCheck.aspx.vb" Inherits="Reports_Rentals_ReservationSpotCheck" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        ...
        <tr>
            <td>Date Field:</td>
            <td><asp:DropDownList runat="server" ID="ddField"><asp:ListItem Value="0">Date Booked</asp:ListItem><asp:ListItem Value="1">Check-In Date</asp:ListItem></asp:DropDownList></td>
        </tr>
        <tr>
            <td>
                Rep(s):</td>
