...
Partial Class Reports_Rentals_BookingAgent
    ...
    Dim sReport As String = "reportfiles/FaithLeads.rpt"
    ...
    Protected Sub Set_Params()
        ...
        If dfEndDate.Selected_Date <> "" Then
            Report.SetParameterValue("EDate", CDate(dfEndDate.Selected_Date).AddDays(1))
        Else
            Report.SetParameterValue("EDate", Date.Today)
        End If
