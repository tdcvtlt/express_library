...
Imports System.Data
Imports System
Partial Class Reports_Rentals_ReservationShowPct
    Inherits System.Web.UI.Page

    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/ReservationShowPct.rpt"

    Private Sub BindData()
        Dim cnn As New SqlConnection(Resources.Resource.cns)
        Dim cmd As New SqlCommand("select b.COMBOITEM, b.COMBOITEMID from t_combos a inner join t_comboitems b on a.comboid = b.comboid where comboname = 'ReservationLocation' order by b.ComboItem asc", cnn)
        cnn.Open()
    ...
    Protected Sub Set_Params()
        ...
        Next
        Report.SetParameterValue("ResLoc", sItems)
