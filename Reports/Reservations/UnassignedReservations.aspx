<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="UnassignedReservations.aspx.vb" Inherits="Reports_Reservations_UnassignedReservations" AspCompat = "true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        ...
        <tr>
            ...
            <td>Sub Type:</td>
            <td><asp:DropDownList id = "ddSubType" runat="server">
        ...
        <tr>
            ...
            <td colspan = '2'><asp:ListBox runat="server" Height="176px" Width="162px" SelectionMode="Multiple" id = "lbSubType"></asp:ListBox>
