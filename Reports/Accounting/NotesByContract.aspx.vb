...
Partial Class Reports_Accounting_NotesByContract
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/NotesByContract.rpt"
    ...
    Protected Sub Set_Params()
        ...
        oCon.Load()
        Report.SetParameterValue("ContractID", oCon.ContractID)
        oCon = Nothing
