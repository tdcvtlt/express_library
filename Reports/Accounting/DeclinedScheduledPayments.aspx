<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="DeclinedScheduledPayments.aspx.vb" Inherits="Reports_Accounting_DeclinedScheduledPayments" %>
...
<div>
    ...
    <table>
        <tr>
            <td>Account:</td>
            <td><asp:DropDownList ID="ddAccountID" runat="server"></asp:DropDownList>
            </td>
        </tr>
        <tr>
