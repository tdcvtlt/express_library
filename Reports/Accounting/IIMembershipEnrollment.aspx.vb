...
Partial Class Reports_Accounting_IIMembershipEnrollment
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        For Each a As StreetAddress1 In ignP.StreetAddresses
        ...
        For Each dr As DataRow In ctx.GetOwners.Rows
            ...
            If dr.Item("Primary").ToString() = "1" Then
                ...
                For Each r In dt.Rows
                    owner_pr.Addresses.Add(New Address_2 _
                        With { _
        ...
        For Each list_owner As Owner In OwnersList
            ...
            For i = 0 To MAX_ADDRESSES - 1
                Try
                    ...
                    Dim kcp_address As Address_2 = list_owner.Addresses(i)
...
#Region "Private functions"
    ...
    Private Function get_UnitCheckInDay(ByVal soldInventoryId As String) As String
        Dim s = String.Empty
    ...
    Private Function get_ContractNumber(contractid As Int32) As String
    ...
    Private Function get_Inventories(contractId As Int32) As Inventory()
...
#Region "Inner Classes"
    ...
    Public Class Owner
        ...
        Private _addresses As IList(Of Address_2) = New List(Of Address_2)
        ...
        Public Property Addresses As IList(Of Address_2)
            Get
                Return _addresses
            End Get
            Set(ByVal value As IList(Of Address_2))
                _addresses = value
            End Set
        End Property
...
#End Region
    ...
    Private Class Prospect
            ...
            Using cnn = New SqlConnection(Resources.Resource.cns)
                Using ada = New SqlDataAdapter(sql, cnn)
                    ...
                    If dt.Rows.Count = 1 Then
                        ...
                        Dim l As New List(Of StreetAddress1)
                        For Each d As DataRow In dt.Rows

                            Dim st As New StreetAddress1(d.Field(Of Int32)("AddressID")) With {.Prospect = Me}
                            l.Add(st)
                        Next
        ...
        Public ReadOnly Property Addresses As Addresses
            Get
                Return New Addresses(_prospectID)
            End Get
        End Property
    End Class

    Private Class StreetAddress1
    ...
    Private Class Addresses
        ...
        Public Function GetEnumerator() As System.Collections.IEnumerator Implements System.Collections.IEnumerable.GetEnumerator
            ...
            Return New Enumerator(tb.Where(Function(x) x.ProspectID.Equals(_prospectID)).ToArray())
        End Function
    ...
    Private Class Inventories
        ...
        Private Class Enumerator
            ...
            Public Sub New(inventories() As Inventory)
                l = inventories
            End Sub
    ...
    Private Class StreetAddresses
        ...
        ' local variable
        Private _list As StreetAddress1()


        Public Sub New(l As StreetAddress1())
            _list = l
        End Sub
        ...
        Private Class MyEnumerator
            ...
            Private position As Integer = -1
            Private list As StreetAddress1()
    ...
    Protected Sub lnk_view_4_Click(sender As Object, e As System.EventArgs) Handles lnk_view_4.Click
        ...
        Dim a As New Addresses(15143473)
        For Each b As Address In a
            Response.Write(String.Format("<strong>{0}, <span>{1}</span></strong></br>", b.Address1, b.ProspectID))
        Next
