...
Partial Class Reports_Accounting_RentalPayrollReport
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/RentalPayrollReport.rpt"
    ...
    Protected Sub Set_Params()
        ...
        If dfEndDate.Selected_Date <> "" Then
            Report.SetParameterValue("EDate", CDate(IIf(dfEndDate.Selected_Date <> "", CDate(dfEndDate.Selected_Date).AddDays(0), Date.Today)))
        Else
