<%@ Page Title="Maintenance Fee Report" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="MaintenanceFeeReport.aspx.vb" Inherits="Reports_Accounting_MaintenanceFeeReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        ...
        <tr><td colspan="3">Transaction Code(s):</td></tr>
        <tr>
            <td>
