...
Partial Class Reports_Accounting_DeclinedScheduledPayments
    Inherits System.Web.UI.Page


    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/SchedPaymentDeclined.rpt"

    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If IsPostBack Then

        Else
            Dim oAcct As New clsCCMerchantAccount
            ddAccountID.DataSource = oAcct.List_Accounts
            ddAccountID.DataTextField = "Description"
            ddAccountID.DataValueField = "AccountID"
            ddAccountID.DataBind()
            oAcct = Nothing
        End If
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("AcctID", ddAccountID.SelectedValue)
    End Sub
