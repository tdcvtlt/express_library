...
Partial Class Reports_Accounting_ClubFeeAging
    Inherits System.Web.UI.Page


    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/clubfeeaging.rpt"
    Private Sub BindData()

        Dim ds As New SqlDataSource
        ds.ConnectionString = Resources.Resource.cns
        ds.SelectCommand = "Select * from t_FinTransCodes f inner join t_Comboitems tc on tc.comboitemid = f.transcodeid where tc.comboitem like 'cd%'"
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        If DateField1.Selected_Date <> "" And ListBox2.Items.Count > 0 Then
            ...
            Report.SetParameterValue("@KeyField", "ProspectID")
    ...
    Private Sub Setup_Report()
        If Session("Report") Is Nothing Then
            ...
            Report.SetParameterValue("@KeyField", "ProspectID")
            Report.SetParameterValue("@TransCode", "CD11")
