...
Partial Class Reports_Accounting_FundingSalesSummary
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/FundingSalesSummary.rpt"
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("StartDate", CDate(IIf(dteSDate.Selected_Date <> "", dteSDate.Selected_Date, Date.Today)))
        Report.SetParameterValue("EndDate", CDate(IIf(dteEDate.Selected_Date <> "", dteEDate.Selected_Date, Date.Today)))
