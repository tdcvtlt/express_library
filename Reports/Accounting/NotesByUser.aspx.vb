...
Partial Class NotesByUser_Default
    Inherits System.Web.UI.Page

    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/NotesByUser.rpt"
    Private Sub BindData()

        Dim ds As New SqlDataSource
        ds.ConnectionString = Resources.Resource.cns
        ds.SelectCommand = "Select *, lastname + ', ' + firstname as Name from t_Personnel where active = 1 order by lastname, firstname"
    ...
    Protected Sub Button3_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles Button3.Click
        If sDate.Selected_Date <> "" And EDate.Selected_Date <> "" And ListBox2.Items.Count > 0 Then
            ...
            Report.SetParameterValue("PerID", sItems)
    ...
    Private Sub Setup_Report()
        If Session("Report") Is Nothing Then
            ...
            Report.SetParameterValue("PerID", "0")
