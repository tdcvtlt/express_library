...
Partial Class Reports_Contracts_DailyTrans
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/DailyTrans.rpt"
    ...
    Protected Sub Set_Params()
        ...
        Dim eDate As Date = Date.Today.AddDays(1)
        If dfEndDate.Selected_Date <> "" Then
            eDate = CDate(dfEndDate.Selected_Date).AddDays(1)
        End If
