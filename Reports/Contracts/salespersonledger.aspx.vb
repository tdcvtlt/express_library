...
Partial Class Reports_Tours_SalesPersonLedger
    Inherits System.Web.UI.Page
    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/SalesPersonLedger.rpt"
    ...
    Protected Sub btnRun_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnRun.Click
        If dfSDate.Selected_Date <> "" And dfEdate.Selected_Date <> "" And txtFName.Text <> "" And txtLName.Text <> "" Then
    ...
    Protected Sub Set_Params()
        ...
        Report.SetParameterValue("FName", txtFName.Text)
        Report.SetParameterValue("LName", txtLName.Text)
    End Sub
End Class
