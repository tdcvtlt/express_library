...
Partial Class Reports_CustomerService_Premier2_DYDInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>Premier2-DYD Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=Premier2-DYDInvoice.xls")
