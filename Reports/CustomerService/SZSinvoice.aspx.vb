...
Partial Class Reports_CustomerService_SZSInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>SZA Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
            ...
            Do While Not rs.EOF
                If CInt(rs.Fields("TourID").Value) <> prevID Then
                    ...
                    If rs.Fields("TourStatus").Value & "" = "Showed" Then
                        If rs.Fields("CampaignName").Value.ToString().ToUpper() = "SZS" Then
                            tourFee = 250
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=SZSInvoice.xls")
