...
Partial Class Reports_Packages_AMDInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>AMD Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
            ...
            Do While Not rs.EOF
                If CInt(rs.Fields("TourID").Value) <> prevID Then
                    ...
                    If rs.Fields("TourStatus").Value = "Showed" Then
                        ...
                        If rs.Fields("CampaignName").Value.ToString().ToUpper() = "AMD" Then
                            tourFee = 390
                            tourCost = tourFee - premCost
                        ElseIf rs.Fields("CampaignName").Value.ToString().ToUpper() = "AMD-F" Then
                            tourFee = 390
                            tourCost = tourFee - premCost
                        End If
