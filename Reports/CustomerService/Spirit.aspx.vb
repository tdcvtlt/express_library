...
Partial Class Reports_CustomerService_Spirit
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        sANs = "<H2>SPIRIT Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
        ...
        Else
            Do While Not rs.EOF
                ...
                If rs.Fields("TourStatus").Value = "No Tour - Overage" Or rs.Fields("TourStatus").Value = "Showed" Or rs.Fields("TourStatus").Value = "OnTour" Or (rs.Fields("TourStatus").Value = "NQ - Toured" And Not (IsDBNull(rs.Fields("ContractNumber").Value))) Then
                    ...
                    If rs.Fields("Campaign").value = "MDI/PKT" Then
                        tourFee = 300
                    ElseIf rs.Fields("Campaign").value = "MDI/SML" Then
                        tourFee = 220
                    ElseIf rs.Fields("Campaign").value = "MDI-SS" Then
                        tourFee = 325
                    ElseIf rs.Fields("Campaign").value.ToString().ToUpper() = "spirit".ToUpper() Then

                        'tourFee = 350
                        'per work order #41477 change from $350 to $325
                        tourFee = 325
                ...
                sANs = sANs & "<td align=right>" & FormatCurrency(tourFee - premCost) & "</td>"
