<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="VendorRefunds.aspx.vb" Inherits="Reports_CustomerService_VendorRefunds" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td>Vendor:</td>
            <td><asp:DropDownList ID="ddVendorID" runat="server"></asp:DropDownList></td>
        </tr>
            <tr>
            <td>Start Date:</td>
            <td>
