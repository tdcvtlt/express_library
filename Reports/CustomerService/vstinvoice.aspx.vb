...
Partial Class Reports_CustomerService_vstinvoice
    ...
    Protected Sub btn_Submit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles btn_Submit.Click
        ...
        Using cn As New SqlConnection(Resources.Resource.cns)
            sqlText = String.Format( _
                 ...
                 "   WHERE (b.Package LIKE 'vst%') AND (e.Type = 'Create') and e.KeyField = 'PackageIssuedID' and " & _
        ...
        If gvr.RowType = DataControlRowType.DataRow Then           
            ...
            Using cn = New SqlConnection(Resources.Resource.cns)
                Dim sqlText = String.Format( _
                                ...
                                "from UFN_Financials(0,'PackageIssuedID',{0},0) where (invoice like 'vst%') ", id_package_issued)
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("content-disposition", "attachment;filename=vstinvoice.xls")
