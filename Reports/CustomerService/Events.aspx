<%@ Page Title="Events Tracking" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="Events.aspx.vb" Inherits="Reports_Accounting_Events" %>
...
<tr>
    <td>Start Date:</td>
    <td colspan="2"><dtc:DateField ID="SDATE" runat="server" /></td>
    
</tr>
<tr>
    <td>End Date:</td>
    <td colspan="2"><dtc:DateField ID="EDATE" runat="server" /></td>
</tr>
<tr>
    <td>
        Personnel:<br />
        <asp:ListBox ID="lbPersonnel2" runat="server"></asp:ListBox>
    </td>
    <td>
    ...
    <td>
        Selected:<br />
        <asp:ListBox ID="lbSelected2" runat="server"></asp:ListBox>
    </td>
