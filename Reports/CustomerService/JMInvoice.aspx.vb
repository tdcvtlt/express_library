...
Partial Class Reports_CustomerService_JMInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>J&M Invoice " & sdate & " - " & edate & "</H2>"
        ...
        Else
            Do While Not rs.EOF
                ...
                If rs.Fields("TourStatus").Value = "Showed" Or rs.Fields("TourStatus").Value = "OnTour" Or (rs.Fields("TourStatus").Value = "NQ - Toured" And Not (IsDBNull(rs.Fields("ContractNumber").Value))) Then
                    If Weekday(rs.Fields("TourDate").Value) = 7 Or Weekday(rs.Fields("TourDate").Value) = 1 Then
                        tourFee = 350
                    Else
                        tourFee = 375
                    End If
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=JMInvoice.xls")
