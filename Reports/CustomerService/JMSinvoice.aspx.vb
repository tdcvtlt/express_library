...
Partial Class Reports_CustomerService_JSMInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>JMS Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
            ...
            Do While Not rs.EOF
                If CInt(rs.Fields("TourID").Value) <> prevID Then
                    ...
                    If rs.Fields("TourStatus").Value = "Showed" Then
                        If rs.Fields("CampaignName").Value.ToString().ToUpper() = "JMS" Then
                            tourFee = 250
