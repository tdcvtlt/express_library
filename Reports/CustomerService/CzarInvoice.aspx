<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="CzarInvoice.aspx.vb" Inherits="Reports_CustomerService_CzarInvoice" AspCompat = "true" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        ...
        <tr>
            <td><asp:Button runat="server" Text="Button" ID="btn_Unnamed1" onclick="Unnamed1_Click"></asp:Button></td>
