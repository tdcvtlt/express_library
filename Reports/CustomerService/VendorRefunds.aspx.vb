...
Imports System.Data
Imports System
Partial Class Reports_CustomerService_VendorRefunds
    Inherits System.Web.UI.Page

    Dim Report As New ReportDocument
    Dim sReport As String = "reportfiles/VendorRefunds.rpt"
    ...
    Protected Sub BindData()
        ddVendorID.DataSource = (New clsVendor).List_Vendors
        ddVendorID.DataValueField = "VendorID"
        ddVendorID.DataTextField = "Vendor"
        ddVendorID.DataBind()
    End Sub
    ...
    Protected Sub Set_Params()
        Report.SetParameterValue("VendorID", ddVendorID.SelectedValue)
