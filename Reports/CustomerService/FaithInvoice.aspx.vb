...
Partial Class Reports_CustomerService_FaithInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        sANs = "<H2>FAITH Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
    ...
    Protected Sub Button2_Click(sender As Object, e As System.EventArgs) Handles Button2.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=FAITHInvoice.xls")
