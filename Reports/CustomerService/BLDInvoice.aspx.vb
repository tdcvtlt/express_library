...
Partial Class Reports_CustomerService_BLDInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>BLD Invoice " & sdate & " - " & edate & "</H2>"
