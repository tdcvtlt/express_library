...
Partial Class Reports_CustomerService_MHMTourInvoice
    ...
    Private Sub show_report()
        ...
        sANs = "<H2>MHM Tour Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
                    ...
                    If (String.Compare(rs.Fields("reservationLocation").Value.ToString().ToUpper(), "KCP") = 0 Or _
                        ...
                        Else
                            ...
                            Else
                                ...
                                Else
                                    rs2.Close()
                                    rs2.Open("Select Sum(p.Amount) as CBAmount from t_Invoices i inner join t_Payment2Invoice pi on i.InvoiceID = pi.InvoiceID inner join t_Payments p on pi.PaymentID = p.PaymentID inner join t_COmboItems pm on p.MethodID = pm.ComboItemID where i.KeyField = 'ReservationID' and i.KeyValue = " & rs.Fields("ReservationID").Value & " and pm.ComboItem = 'Chargeback - MHM'", cn, 3, 3)
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=MHMTourInvoice.xls")
