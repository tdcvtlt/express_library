...
Partial Class Reports_PrestigeInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        sANs = "<H2>Prestige Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
        ...
        Else
            Do While Not rs.EOF
                ...
                If rs.Fields("TourStatus").Value = "Showed" Then ' or rs.Fields("TourStatus") = "OnTour" or (rs.Fields("TourStatus") = "NQ - Toured" and Not(IsNull(rs.Fields("ContractNumber")))) then
                    tourFee = 250
                Else
                    tourFee = 0
                End If
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=PrestigeInvoice.xls")
