...
Partial Class Reports_CustomerService_HTIInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sAns = "<H2>HTI Invoice " & sDate & " - " & eDate & "</H2>"
        sAns = sAns & "<table>"
        sANs = sANs & "<tr>"
