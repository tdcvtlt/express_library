...
Partial Class Reports_CustomerService_JW_ShowInvoice
        ...
        Using cnn = New SqlConnection(Resources.Resource.cns)
            Using ada = New SqlDataAdapter(sql, cnn)
                ...
                If dt.Rows.Count = 0 Then
                    ...
                    Return
                Else
                    sb.Append("<H2>JW-Show Invoice " & sd & " - " & ed & "</H2><table border=1 style=border-collapse:collapse;><tr>")
                ...
                For Each row As DataRow In dt.Rows
                    ...
                    Using cmd = New SqlCommand(sql, cnn)
                        ...
                        Try
                            ...
                            Dim tc As Decimal = IIf(row.Item("TourStatus").ToString() = "Showed", "350.00", "0.00")
    ...
    Protected Sub btnExcel_Click(sender As Object, e As System.EventArgs) Handles btnExcel.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=JWSHowInvoice.xls")
