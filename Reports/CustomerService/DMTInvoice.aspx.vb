...
Partial Class Reports_CustomerService_DMTInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        sANs = "<H2>DMT Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
        ...
        Else
            Do While Not rs.EOF
                ...
                If FormatCurrency(premCost) > 50 And tourFee > 0 Then
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=DMTInvoice.xls")
