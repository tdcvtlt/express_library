...
Partial Class Reports_CustomerService_EMSInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sAns = "<H2>EMS Invoice " & sDate & " - " & eDate & "</H2>"
        sAns = sAns & "<table>"
        sAns = sAns & "<tr>"
    ...
    Protected Sub Button3_Click(sender As Object, e As System.EventArgs) Handles Button3.Click
        ...
        Response.AddHeader("Content-Disposition", "attachment; filename=EMSInvoice.xls")
