...
Partial Class Reports_CustomerService_MDIInvoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs) Handles Button1.Click
        ...
        sANs = "<H2>MDI Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
            ...
            Do While Not rs.EOF
                ...
                If rs.Fields("TourStatus").Value = "No Tour - Overage" Or rs.Fields("TourStatus").Value = "Showed" Or rs.Fields("TourStatus").Value = "OnTour" Or (rs.Fields("TourStatus").Value = "NQ - Toured" And Not (IsDBNull(rs.Fields("ContractNumber").Value))) Then
                    ...
                    ElseIf rs.Fields("Campaign").value = "MDI-SS" Then
                        tourFee = 325
                    ElseIf rs.Fields("Campaign").value = "MDI-L" Then
                        tourFee = 275  'per WO# 41676 #7/9/14#
                    ElseIf rs.fields("Campaign").value = "MDI-LCM" Then
                        tourFee = 380 ' per WO# 42999 3/6/15
                    ElseIf rs.fields("Campaign").value = "MDI-I" Then
                        tourFee = 325 ' per WO# 43797 6/29/15
                    Else
                        tourFee = 275
                    End If
                    'Else
