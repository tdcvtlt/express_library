...
Partial Class Reports_CustomerService_Marketing_Gurus_Dyd_Invoice
    ...
    Protected Sub Unnamed1_Click(sender As Object, e As System.EventArgs)
        ...
        sANs = "<H2>Marketing Gurus - DYD Invoice " & sdate & " - " & edate & "</H2>"
        sANs = sANs & "<table>"
        sANs = sANs & "<tr>"
            ...
            Do While Not rs.EOF
                If CInt(rs.Fields("TourID").Value) <> prevID Then
                    ...
                    If rs.Fields("TourStatus").Value & "" = "Showed" Then
                        If rs.Fields("CampaignName").Value.ToString().ToUpper() = "Gurus".ToUpper() Then
                            tourFee = 300
