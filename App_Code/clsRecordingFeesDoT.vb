...
Public Class clsRecordingFeesDoT
    ...
    Public Sub New()
        ...
        cm = New SqlCommand("Select * from t_RecordingFeesDoT where RecordingFeeID = " & _ID, cn)
    End Sub

    Public Sub Load()
        Try
            cm.CommandText = "Select * from t_RecordingFeesDoT where RecordingFeeID = " & _ID
            da = New SqlDataAdapter(cm)
            ds = New DataSet
            da.Fill(ds, "t_RecordingFeesDoT")
            If ds.Tables("t_RecordingFeesDoT").Rows.Count > 0 Then
                dr = ds.Tables("t_RecordingFeesDoT").Rows(0)
                Set_Values()
            End If
    ...
    Public Function Save() As Boolean
        Try
            ...
            If ds.Tables("t_RecordingFeesDoT").Rows.Count > 0 Then
                dr = ds.Tables("t_RecordingFeesDoT").Rows(0)
            Else
                da.InsertCommand = New SqlCommand("dbo.sp_RecordingFeesDoTInsert", cn)
                ...
                dr = ds.Tables("t_RecordingFeesDoT").NewRow
            End If
            ...
            If ds.Tables("t_RecordingFeesDoT").Rows.Count < 1 Then ds.Tables("t_RecordingFeesDoT").Rows.Add(dr)
            da.Update(ds, "t_RecordingFeesDoT")
            _ID = ds.Tables("t_RecordingFeesDoT").Rows(0).Item("RecordingFeeID")
