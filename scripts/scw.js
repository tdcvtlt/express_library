...
//******************************************************************************
	...
	var scwBaseYear = 1998;	


    // How many years do want to be valid and to show in the drop-down list?

    var scwDropDownYears   = (scwDateNow.getFullYear() + 4) - scwBaseYear;
...
// ****************************************************************************
    ...
    function scwShow(scwEle,scwSourceEle)
        {scwTriggerEle = scwSourceEle;
       	...
       	if (scwEle.name == 'BirthDate')
       	{
       		scwBaseYear = 1900;
       		scwDropDownYears   = (scwDateNow.getFullYear() -18) - scwBaseYear;
       	}
             ...
             function scwSetOutput(scwOutputDate)
                {
                	...
                	if (document.Update_Dates)
               	 	{
               	 		Update_Dates();
               		 }
                scwTargetEle.value = scwOutputDate.scwFormat(scwDateOutputFormat);
                    if(scwTargetEle.name == 'CheckInDate')
               		{
                		Get_CheckOut_Dates();
                	}
                	if(scwTargetEle.name == 'indate')
                	{
                		Get_UsageOut_Date();
                	}

                	if(scwTargetEle.name == 'OriginationDate' || scwTargetEle.name == 'FirstPaymentDate'){
                		ReCalcAll();
                	}
                 scwHide();
                }
