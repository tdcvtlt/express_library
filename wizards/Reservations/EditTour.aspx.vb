...
Partial Class wizard_Reservations_Tour
    ...
    Private Sub Form_Load()
        ...
        If multiview1.GetActiveView().Equals(view1) Then
            ...
            Try
                ...
                gridview1.DataSource = package_x.Get_Tours_Available(wiz.Search_CheckIn_Date, wiz.Search_CheckOut_date.Value.Subtract(wiz.Search_CheckIn_Date).Days,
        ...
        If multiview1.GetActiveView().Equals(view1) Then
            With wiz.Tour
                ...
                Try
                    ...
                    Dim tours_avail_dt = package_x.Get_Tours_Available(wiz.Search_CheckIn_Date, wiz.Search_CheckOut_date.Value.Subtract(wiz.Search_CheckIn_Date).Days,
                        campaign_id, tour_location_id)
                    Dim is_match = False
