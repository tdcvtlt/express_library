...
Partial Class wizard_Reservations_Allocation
        ...
        Private iGrid As Alloc.IGridRefresh
...
#Region "Event Handlers"
        ...
        Protected Sub gridview1_RowCommand(sender As Object, e As GridViewCommandEventArgs) Handles gridview1.RowCommand
            ...
            If button.ID = "btSelect" Then
                ...
                Dim o = CType(iGrid, Alloc.Scenario_B)
        ...
        If TypeOf iGrid Is Alloc.Scenario_A Then

            Dim o = CType(iGrid, Alloc.Scenario_A)
        ...
        If TypeOf iGrid Is Alloc.Scenario_B Then
        ...
        Protected Sub btNext_Click(sender As Object, e As EventArgs) Handles btNext.Click
            ...
            Try
                ...
                For Each w_p As Wizard_Package In wiz.Packages
                    If wiz.Scenario = EnumScenario.One Or wiz.Scenario = EnumScenario.Two Then
                        For Each r_w As Wizard_Room In w_p.RoomID_List
                            rooms_id.Add(r_w.Room_ID)
                        Next
                    ElseIf wiz.Scenario = EnumScenario.Three Then
                        For Each r_w As Wizard_Room In w_p.Package.RoomID_List
                            rooms_id.Add(r_w.Room_ID)
                        Next
                    End If
                Next
...
Namespace Alloc
    ...
    Class Scenario_A
        Implements IGridRefresh

        Private package_x As New Package_Xtra
        Private package_base As New Base_Package

        Public Function Search_Available_Rooms(package_guid As String, packages As List(Of Wizard_Package), checkin_date As DateTime, nights_stay As Int32) As DataTable Implements IGridRefresh.Search_Available_Rooms
            ...
            Return dt
        End Function
        Public Sub Add_Room(p_guid As String, r_guid As String, packages As List(Of Wizard_Package)) Implements IGridRefresh.Add_Room
            ...
            Next
        End Sub
        Public Sub Remove_Room(p_guid As String, packages As List(Of Wizard_Package)) Implements IGridRefresh.Remove_Room
            packages.Single(Function(x) x.GUID = p_guid).RoomID_List.Clear()
        End Sub
        Public Function Ensure_Rooms_Allocated(packages As List(Of Wizard_Package)) As Boolean Implements IGridRefresh.Ensure_Rooms_Allocated
            Dim tf = True
            For Each p As Wizard_Package In packages
                If p.RoomID_List.Count = 0 Then
                    tf = False
        ...
        'gridview3  
        Public Sub Refresh_Rooms(gv As GridView, packages As List(Of Wizard_Package)) Implements IGridRefresh.Refresh_Rooms
            Dim dt = New DataTable()
            With dt
                .Columns.Add("Unit")
                .Columns.Add("Room")
            ...
            gv.DataBind()
        End Sub
        Public Sub GridView_RowDataBound(sender As Object, e As GridViewRowEventArgs) Implements IGridRefresh.GridView_RowDataBound
            If e.Row.RowType = DataControlRowType.DataRow Then
                Dim dataItem = CType(e.Row.DataItem, DataRowView)
