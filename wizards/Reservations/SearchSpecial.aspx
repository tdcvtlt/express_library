<%@ Page Title="" Language="VB" MasterPageFile="~/wizards/Reservations/ReservationMasterPage.master" Debug="true" AutoEventWireup="false" CodeFile="SearchSpecial.aspx.vb" EnableEventValidation="false" ValidateRequest="false"  Inherits="wizard_Reservations_SearchSpecial" %>
       ...
       $(function () {
           ...
           $("span[cbAttr] :checkbox:first-child").click(function (e) {
               ...
               if ($(cb).parents('tr').children('td:nth-child(5)').children('select:first').val() == 'Tour Required' && $(cb).prop('checked')) {
                   ...
                   $.ajax({
                       type: "POST",
                       url: "SearchSpecial.aspx/ufn_ToursAvailability",
                    ...
                    <div class="panel panel-success">
                        ...
                        <div class="panel-body">
                            <div style="position:relative;width:100%;float:left;">
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="row top-buffer" style="visibility:hidden;">
                                            <div class="col-sm-4">
                        ...
                        <div runat="server" id="dvR_Container" style="clear:left;margin-top:0px;">     
                            ...
                            <tr style="height:70px;">
                                ...
                                <td style="text-align:right;">    
                                    <asp:Label ID="lbMin" runat="server" Text="Minimum" Font-Size="Medium" Visible="false" CssClass="control-label" style="padding-right:6px;"></asp:Label>         
                                    <br />                                               
                                    <asp:TextBox runat="server" ID="txMin" ReadOnly="true" Visible="false" CssClass="form-control" Font-Size="Medium" Text="0.00" Font-Bold="true"  style="text-align:right;vertical-align:middle;width:70%;float:right;"></asp:TextBox>
                                </td>
                                <td>                            
                                </td>
                                <td style="text-align:right;">      
                                    <asp:Label ID="lbMax" runat="server" Text="Maximum" Visible="false" Font-Size="Medium" CssClass="control-label" style="padding-right:6px;"></asp:Label>    
                                    <br />                                                                                                              
                                    <asp:TextBox runat="server" ID="txMax" ReadOnly="true" Visible="false" CssClass="form-control" Font-Size="Medium"  Font-Bold="true"   Text="0.00" style="text-align:right;vertical-align:middle;width:70%;float:right;"></asp:TextBox>
                                </td>
                                <td>&nbsp;                            
                                </td>
                                <td style="text-align:right;">
                                    <asp:Label ID="lbPurchase" runat="server" Text="Purchase" Font-Size="Medium" Visible="false" CssClass="control-label" style="padding-right:6px;"></asp:Label>              
                                    <br />                                                                                                                                                            
                                    <asp:TextBox runat="server" ID="txP"  CssClass="form-control" Visible="false" AutoPostBack="false" Font-Bold="true"  name="txP" Text="0.00" Font-Size="Medium" style="text-align:right;vertical-align:middle;width:60%;float:right;"></asp:TextBox>
                                </td>   
                                <td>&nbsp;</td>                     
                            </tr>
                            <tr>
