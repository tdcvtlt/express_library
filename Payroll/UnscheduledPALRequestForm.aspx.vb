Imports System
Imports System.Data
Partial Class Payroll_UnscheduledPALRequestForm
    ...
    Protected Sub lbAddDates_Click(sender As Object, e As System.EventArgs) Handles lbAddDates.Click
        If dteSDate.Selected_Date = "" Or dteEDate.Selected_Date = "" Or Not (IsNumeric(CInt(txtPALHours.Text))) Or Not (IsNumeric(CInt(txtUnpaidHours.Text))) Then 'Or Not (IsNumeric(CInt(txtSSLBHours.Text))) Then '
        ...
        ElseIf txtReason.Text = "" Then
            ScriptManager.RegisterStartupScript(Me, Me.GetType, "AjaxCall", "alert('Please Give a Reason For Your Absence.');", True)
        ElseIf txtPALHours.Text <= 0 And txtUnpaidHours.Text <= 0 Then ' AND txtSSLBHours.Text <= 0 Then 
    ...
    Protected Sub btnSubmit_Click(sender As Object, e As System.EventArgs) Handles btnSubmit.Click
        ...
        Else
            ...
            If bProceed Then
                ...
                'oPALForm.TotalSSLBHours = lblSSLBHours.Text
                oPALForm.TotalUnpaidHours = lblUnpaidHours.Text
                oPALForm.Scheduled = False
                oPALForm.DoctorsNote = cbDocNote.Checked
                oPALForm.Save()
                ...
                For Each Row As GridViewRow In gvDates.Rows
                    ...
                    oPALDates.Reason = Row.Cells(5).Text
