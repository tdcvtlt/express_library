<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="SSLBFormApproval.aspx.vb" Inherits="Payroll_SSLBFormApproval" %>
...
<asp:MultiView runat="server" ID="MultiView1">
    <asp:View runat="server" id = "View_1">
        <asp:GridView runat="server" id = "gvPendingRequests" 
            autoGenerateColumns = "False" EmptyDataText = "No Pending SSLB Requests" 
            ...
            <Columns>
                ...
                <asp:BoundField DataField="RequestedBy" HeaderText="Requesting Manager"></asp:BoundField>
        ...
        <asp:Button ID="btnProcessPending" runat="server" Text="Process SSLB Requests"></asp:Button>
    </asp:View>
</asp:MultiView>
</asp:Content>
