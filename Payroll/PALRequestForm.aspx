<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PALRequestForm.aspx.vb" Inherits="Payroll_PALRequestForm" %>
...
<body>
    ...
    <div>
        <center>
            ...
            <br />
            <center><b>REQUEST FOR TIME OFF</b></center>
            <center><b>SCHEDULED LEAVE</b></center>
            <br /><br />
            <div id = "innerContent">
            <b>This form is initiated by employee to request time off 30 days in ADVANCE of absence (if possible) from a scheduled work shift with or without pay. <i>Approval is at the discretion of the Department Supervisor according to staffing needs.</i></b>
            ...
            <br />
            I am requesting to be away from work on the date(s) listed below:
            <br />
