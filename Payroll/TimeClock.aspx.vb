...
Partial Class Payroll_TimeClock
    ...
    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        ...
        Else
            ...
            If MultiView1.ActiveViewIndex = 0 And txtSwipe.Text <> "" Then Unnamed1_Click(sender, e)
        End If
    End Sub
    ...
    Private Sub Punch_In(persID As Integer, deptID As Integer)
        ...
        If oPersPunch.Val_Punch_In(persID, deptID) Then
            ...
            If mp <> "" Then
                ClientScript.RegisterClientScriptBlock(Me.GetType, "AjaxCall", "var r = confirm('" & mp & " Would you like to submit a missed punch form now?'); if(r==true){modal.mwindow.open(" & Chr(39) & Request.ApplicationPath & "/Payroll/MissedPunchRequest.aspx?PersonnelID=" & hfPersID.Value & Chr(39) & "," & Chr(39) & "win01" & Chr(39) & ",350,350);}", True)
            Else
    ...
    Private Sub Punch_Out(ByVal persID As Integer, ByVal deptID As Integer)
        ...
        Dim pID As Integer = 0
        Dim mp As String = ""
        mp = oPersPunch.Missed_Punch_Check(persID, deptID, "Out")
        If mp <> "" Then
            ClientScript.RegisterClientScriptBlock(Me.GetType, "AjaxCall", "var r = confirm('" & mp & " Would you like to submit a missed punch form now?'); if(r==true){modal.mwindow.open(" & Chr(39) & Request.ApplicationPath & "/Payroll/MissedPunchRequest.aspx?PersonnelID=" & hfPersID.Value & Chr(39) & "," & Chr(39) & "win01" & Chr(39) & ",350,350);}", True)
        Else
            pID = oPersPunch.Get_Current_Punch(hfPersID.Value)
            If pID > 0 Then
                ...
                MultiView1.ActiveViewIndex = 1
            Else
                ClientScript.RegisterClientScriptBlock(Me.GetType, "AjaxCall", "var r = confirm('You are attempting to punch out without punching in for this shift. You will need to submit a missed punch form before you are able to punch out. Would you like to submit a missed punch form now?'); if(r==true){modal.mwindow.open(" & Chr(39) & Request.ApplicationPath & "/Payroll/MissedPunchRequest.aspx?PersonnelID=" & hfPersID.Value & Chr(39) & "," & Chr(39) & "win01" & Chr(39) & ",350,350);}", True)
            End If
