<%@ Page Title="TimeClock" Language="VB" AutoEventWireup="false" CodeFile="Standalone TimeClock.aspx.vb" Inherits="Payroll_TimeClock" %>
<html>
<head runat = "server">
<script language ="javascript" type="text/javascript">
    ...
    function Punch_Out(deptID) {
        document.getElementById("ctl00_ContentPlaceHolder1_hfDeptID").value = deptID
        __doPostBack('ctl00$ContentPlaceHolder1$lbCODept', '');
    }
