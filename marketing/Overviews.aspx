<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="Overviews.aspx.vb" Inherits="marketing_Overviews" %>
    ...
    <table>
        ...
        <tr>
            <td colspan = '2'><asp:Button runat="server" Text="Query" onclick="Unnamed1_Click"></asp:Button>
                <asp:Button runat="server" Text="Add New" onclick="Unnamed2_Click"></asp:Button></td>
        </tr>    
    </table>
