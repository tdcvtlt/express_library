<%@ Page Title="Premiums" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="Premiums.aspx.vb" Inherits="marketing_Premiums" %>
...
<asp:Label ID="Label2" runat="server" Text="Filter: "></asp:Label>
    ...
    <br />
    <br />
<asp:Label ID="Label1" runat="server" Text="Enter Premium Name:"></asp:Label><br />
