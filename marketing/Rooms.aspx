<%@ Page Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="Rooms.aspx.vb" Inherits="marketing_Rooms" title="Room Search" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script type="text/javascript" language="javascript">
        function Update_Text() {
            ...
            var sText = (sel.options[sel.selectedIndex].value == 'Room Number') ? 'Enter a Room Number:' : 'Enter an Extension:';
