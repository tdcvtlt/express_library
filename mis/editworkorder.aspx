...
<%@ Register src="../controls/UploadedDocs.ascx" tagname="UploadedDocs" tagprefix="uc5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ul id="menu">
        ...
        <li <%if  MultiView1.ActiveViewIndex = 2 then: response.write ("class=""current"""):end if %>><asp:LinkButton ID="lbDocuments" runat="server">Documents</asp:LinkButton></li>
        <li <%if  MultiView1.ActiveViewIndex = 3 then: response.write ("class=""current"""):end if %>><asp:LinkButton ID="lbEvents" runat="server">Events</asp:LinkButton></li>
    </ul>
    ...
    <asp:MultiView ID="MultiView1" runat="server">
        ...
        <asp:View ID="View3" runat="server">
            <uc5:UploadedDocs ID="UploadedDocs1" runat="server" KeyField="WorkOrderID" />
        </asp:View>
