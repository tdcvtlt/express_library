<%@ Page Title="" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="EditQuickCheckHist.aspx.vb" Inherits="Maintenance_EditQuickCheckHist" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td>Quick Check Hist ID:</td>
            <td><asp:Label ID="lblQuickCheckHistID" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td>Quick Check Name:</td>
            <td><asp:Label ID="lblQuickCheckName" runat="server"></asp:Label></td>
        </tr>
        <tr>
            <td>Created By:</td>
            ...
            <ItemTemplate>
                ...
                <tr class='data<%#Container.DataItemIndex Mod 2 %>'>
                    ...
                    <td id="Td1" runat="server">
                        <asp:Label ID="IdLabel" runat="server" Text='<%#Eval("QuickCheckHist2Item") %>' />
                    </td>
