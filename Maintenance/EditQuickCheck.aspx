<%@ Page Title="Edit Quick Check" Language="VB" MasterPageFile="~/crms.master" AutoEventWireup="false" CodeFile="EditQuickCheck.aspx.vb" Inherits="Maintenance_EditQuickCheck" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table>
        <tr>
            <td>Quick Check ID:</td>
            <td><asp:Label ID="lbQuickCheckID" runat="server" Text="0"></asp:Label></td>
        </tr>
        <tr>
            <td>Name:</td>
