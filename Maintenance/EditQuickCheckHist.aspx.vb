...
Partial Class Maintenance_EditQuickCheckHist
    ...
    Protected Sub btnComplete_Click(sender As Object, e As EventArgs) Handles btnComplete.Click
        Dim oQC As New clsQuickCheckHist
        oQC.QuickCheckHistID = Request("ID")
        oQC.Load()
        ...
        For Each item As ListViewItem In lvItems.Items
            If Not (IsNothing(item.dataitem)) Then
                ...
                Dim oQCHI As New clsQuickCheckHist2Item
                With oQCHI
                    .QuickCheckHist2Item = rowView("QuickCheckHist2Item")
                    .Load()
