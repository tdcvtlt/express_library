...
Partial Class general_ContractPAPage
    Inherits System.Web.UI.Page

    Protected Sub Page_Load(sender As Object, e As System.EventArgs) Handles Me.Load
        If Not (IsPostBack) Then
            If CheckSecurity("CreditCards", "ContractsPreAuth", "", "", Session("UserDBID")) Then
                Dim acct As String = "'~0004~','~0005~','~0006~'"
    ...
    Private Function Check_Status() As Boolean
        ...
        oCCTrans.Load()
        hfTokenValue.Value = oCCTrans.Token
