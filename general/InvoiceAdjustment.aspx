<%@ Page Language="VB" AutoEventWireup="false" CodeFile="InvoiceAdjustment.aspx.vb" Inherits="general_InvoiceAdjustment" %>
...
<body>
    ...
    <div>
        <table>
            ...
            <tr>
                <td colspan = "2"><asp:button runat="server" text="Process Adjustment" 
